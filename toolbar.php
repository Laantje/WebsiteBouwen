...
<link href="stijlblad1.css" rel="stylesheet" type="text/css"/> 
    ...
    <div id="header">
        <div id="homeknop">
            </br><a href="homepagina.php"><img src="home.png" height="30px"></a>
        </div>
            <div id="topmenu">
                    </br>
                <!-- dit zijn de icons voor de knoppen in de toolbar -->
                <a href="#"><img src="menu.png" height="30px"></a>&nbsp&nbsp
                <a href="inlogpagina.php"><img src="login.png" height="30px"></a>&nbsp&nbsp
                <a href="#"><img src="cart2.png" height="30px"></a>
                <!-- dit is het logo -->
