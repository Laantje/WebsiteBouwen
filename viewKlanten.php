	...
	?>
			<tr>
				...
				<td style="text-align:right;border-bottom:#F0F0F0 1px solid;">
					<a href="viewKlanten.php?action=remove&id=<?php echo $klant_array[$key]["username"]; ?>"><img width="15" height="15" src="img/verwijder.png"></a>
					<a href="editKlanten.php?action=edit&id=<?php echo $klant_array[$key]["username"]; ?>"><img width="15" height="15" src="img/edit.png"></a>
				</td>
			</tr>
